    ...
    const [show, setShow] = useState(false);
        ...
        return (
            ...
            <div className={classes.modify}>
                <div><h2 className={classes.title}>Depósito terceros de dinero</h2>
                <div class="container">
            <div class="row">
            ...
            render={({ errors, status, touched }) => (
                ...
                <Form>
                    ...
                    <div className="form-group">
                        ...
                        <Field name="cbu" type="text" readOnly  className={'form-control' + (errors.cbu && touched.cbu ? ' is-invalid' : '')} />
